...
export class SkillsController {
  ...
  @Get('with-user-levels/:userId')
  async getSkillsWithUserLevels(@Param('userId') userId: string) {
    return this.skillsService.getSkillsWithUserLevels(+userId);
  }
  ...
  async getDepartmentSkillsSummary(
